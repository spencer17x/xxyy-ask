...
describe('resolveFollowUp', () => {
  ...
  it('resolves entry-location product follow-ups using the most recent product topic', () => {
    const recentTurns: SessionTurn[] = [
      {
        content: 'XXYY Pro 有哪些权益？',
        createdAt: '2026-06-19T00:00:00.000Z',
  ...
  it('resolves short product follow-ups using recent non-sensitive product preferences', () => {
    const recentTurns: SessionTurn[] = [
      {
        content: '我主要用手机端。',
        createdAt: '2026-06-19T00:00:00.000Z',
