    ...
    messages: [
      {
        ...
        content: [
          ...
          '- Use search_product_docs when you need to inspect product evidence before answering.',
          '- If a previous search returned no evidence, rewrite the query with more specific product module names, limits, source type, or time/version terms from the user request.',
          '- Do not repeat the same tool name and input; repeated tool input will be stopped by the runtime.',
          '- If search evidence is sufficient, stop searching and let the runtime compose the product answer.',
