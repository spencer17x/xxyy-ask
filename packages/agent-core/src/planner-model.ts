    ...
    messages: [
      {
        ...
        content: [
          ...
          '{"kind":"tool","route":"transaction_analysis","toolName":"analyze_transaction","input":{"txHash":"...","chain":"solana|base|ethereum|bsc"},"reason":"..."}',
          ...
          'Valid route values are exactly: boundary, clarify, product_answer, transaction_analysis, unsupported.',
          ...
          '- You can analyze a single public transaction hash or supported explorer link by calling the transaction analysis tool.',
