      ...
      if (candidateId === 'kc_eval_failed_1') {
        return Promise.resolve([
          ...
          },
          {
            ...
            runId: 'eval_20260619T063000Z_failed1',
            runType: 'eval',
            status: 'failed',
          },
          {
          ...
          evalFailureClusters: [
            {
              ...
              oldestEvaluatedAt: '2026-06-19T06:30:00.000Z',
              reason: 'missing expected answer text',
              runIds: ['eval_20260619T070000Z_failed1', 'eval_20260619T063000Z_failed1'],
              sampleQuestions: ['Telegram 通知怎么设置？'],
              targetCategory: 'eval_case',
              type: 'eval_case',
            },
            {
              candidateIds: ['kc_eval_failed_2'],
              clusterKey: 'expected tx_sandwich_detection, got unknown:eval_case:eval_case',
              count: 1,
              latestEvaluatedAt: '2026-06-19T07:05:00.000Z',
              oldestEvaluatedAt: '2026-06-19T07:05:00.000Z',
              reason: 'expected tx_sandwich_detection, got unknown',
              runIds: ['eval_20260619T070500Z_failed2'],
              sampleQuestions: ['Telegram 通知怎么设置？'],
              targetCategory: 'eval_case',
              type: 'eval_case',
            },
            {
              candidateIds: ['kc_eval_failed_3'],
              clusterKey: 'unknown:eval_case:eval_case',
              count: 1,
              reason: 'unknown',
              runIds: [],
              sampleQuestions: ['Telegram 通知怎么设置？'],
