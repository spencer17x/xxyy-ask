...
apps/
  ...
  cli/        rag:ingest、rag:sync:x、rag:sync:telegram、rag:publish:knowledge、rag:migrate、rag:ask、rag:evaluate、rag:feedback 命令
  web/        静态聊天页面
packages/
  shared/     共享类型
