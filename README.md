...
packages/
  ...
  evm-chain-analysis-readiness/  未接线、离线的 sampling/reviewed replay 治理与生产就绪控制面
  evm-chain-analysis-control-store/  未接线的 Postgres sampling/治理/审计/预算/circuit backend
docs/
